...
export class AddressesComponent implements OnInit {
  ...
  deleteAddress(id) {
    this._httpClient.post<any>(`https://la-petite.ro/la-petite-api/v1/address/delete`,
    {
      'id': id,
    })
    .subscribe(data => {
  ...
  changeAddress(i, f: NgForm) {
    ...
    this._httpClient.post<any>(`https://la-petite.ro/la-petite-api/v1/address/edit`,
      {
